...
export class ProfileCommand implements Command {
    ...
    async execute(intr: CommandInteraction, data: EventData): Promise<void> {
        ...
        const referrals = await GuildReferralDbUtils.getProfileReferralsByUserId(data.userData.id);
        ...
        messageBody += `🔗┃Referral Code: **${code.code}**\n👥┃Referrals: **${
            ...
            away === 1 ? '' : 's'
        } away)**\n🌐┃Referral Link: https://www.syndicatenetwork.io/bot/referral/${code.code}\n\n`;
